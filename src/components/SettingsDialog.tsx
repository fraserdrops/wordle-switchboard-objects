...
export default function SettingsDialog(props: Props) {
  ...
  // TODO selectors
  const hardModeCanBeChanged = true;
  // const hardModeCanBeChanged = useSelector(
  //   actorContext.appActorRef,
  //   AppSelectors.hardModeCanBeChanged
  // );
  const isDarkMode = useSelector(actorContext.appActorRef, AppSelectors.darkMode);
  const isHardMode = useSelector(actorContext.appActorRef, AppSelectors.hardMode);
  const isHighContrastMode = useSelector(actorContext.appActorRef, AppSelectors.highContrast);
